...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Practica 1 LIN");
MODULE_AUTHOR("Marcos Colombas Garcia, German Atalyants Arzumanov");
...
void add(int n) {
    struct list_item *item = (struct list_item *) kvmalloc(sizeof(struct list_item), GFP_KERNEL);
    item->data = n;
